...
def list_buttons():
    #Bottons
    tittle_button = Button(50, 170, 500, 100, pygame.image.load("./assets/img/logo/TurboDash.png"), pygame.image.load("./assets/img/logo/TurboDash2.png"), None)
    play_button = Button(100, 300, 200, 50, pygame.image.load("./assets/img/buttons/playButton1.png"), pygame.image.load("./assets/img/buttons/playButton2.png"), td.run_game)
    quit_button = Button(100, 400, 200, 50, pygame.image.load("./assets/img/buttons/exitButton1.png"), pygame.image.load("./assets/img/buttons/exitButton2.png"), sys.exit)
