...
'''
Button class with its respective attributes and methods. On input, it is sent the x-position, y-position, width, height, image, hover image and the action to be performed by the button.
'''
class Button:
